  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-20">
      ...
      <div className="mb-12 reveal">
        <span className="mb-3 inline-block rounded-full border border-accent/30 bg-accent/10 px-3 py-1 font-mono text-xs font-medium uppercase tracking-wider text-accent">
          Research
        </span>
